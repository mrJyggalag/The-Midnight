...
public class RidgeMergeLayer extends GenLayer {
    private static final int RIDGE_ID = Biome.getIdForBiome(MidnightSurfaceBiomes.BLACK_RIDGE);
    private static final int PLATEUA_ID = Biome.getIdForBiome(MidnightSurfaceBiomes.OBSCURED_PLATEAU);
