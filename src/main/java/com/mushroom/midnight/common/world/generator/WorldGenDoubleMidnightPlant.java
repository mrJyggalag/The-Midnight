...
public class WorldGenDoubleMidnightPlant extends WorldGenerator {
    ...
    public boolean generate(World world, Random rand, BlockPos pos) {
        ...
        for (int i = 0; i < this.spawnCount; ++i) {
            ...
            if (world.isAirBlock(mutablePos) && this.predicate.canSpawn(world, mutablePos, this.state)) {
                world.setBlockState(mutablePos, this.state.withProperty(BlockDoublePlant.HALF, BlockDoublePlant.EnumBlockHalf.LOWER), 2);
                world.setBlockState(mutablePos.up(), this.state.withProperty(BlockDoublePlant.HALF, BlockDoublePlant.EnumBlockHalf.UPPER), 2);
            }
        }
