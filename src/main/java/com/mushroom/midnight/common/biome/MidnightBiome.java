...
public class MidnightBiome extends Biome implements IMidnightBiome {
    ...
    public MidnightBiome(BiomeProperties properties, MidnightBiomeConfig sourceConfig) {
        ...
        this.modSpawnableLists.put(Midnight.MIDNIGHT_MOB, new ArrayList<>(config.getMonsterSpawns()));
        this.modSpawnableLists.put(Midnight.MIDNIGHT_AMBIENT, new ArrayList<>(config.getAmbientCreatureSpawns()));
