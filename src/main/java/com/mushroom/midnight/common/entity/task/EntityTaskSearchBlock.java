...
public class EntityTaskSearchBlock extends EntityAIBase {
    private final EntityCreature owner;
    protected final Predicate<IBlockState> blockPredicate;
    ...
    public EntityTaskSearchBlock(EntityCreature owner, Predicate<IBlockState> blockPredicate, double speed, int searchDist, int searchDelay) {
        this.owner = owner;
