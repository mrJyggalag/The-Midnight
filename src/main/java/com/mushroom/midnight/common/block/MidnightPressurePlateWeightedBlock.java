...
public class MidnightPressurePlateWeightedBlock extends BlockPressurePlateWeighted {
    private final boolean heavyWeighted;
    
    public MidnightPressurePlateWeightedBlock(Material materialIn, boolean heavyWeighted, MapColor mapColorIn, float hardness) {
