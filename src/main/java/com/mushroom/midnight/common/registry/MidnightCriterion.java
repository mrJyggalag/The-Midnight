...
public class MidnightCriterion {
    ...
    public static final StatelessTrigger[] NIGHTSTAG_BOW = new StatelessTrigger[NightStagEntity.MAX_ANTLER_TYPE];
    static  {
        IntStream.range(0, NightStagEntity.MAX_ANTLER_TYPE).forEach(i -> NIGHTSTAG_BOW[i] = CriteriaTriggers.register(new StatelessTrigger(new ResourceLocation(MODID, "nightstag_bow" + i))));
    }
