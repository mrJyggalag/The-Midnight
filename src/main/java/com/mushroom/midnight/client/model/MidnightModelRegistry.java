...
import com.mushroom.midnight.client.render.ShadeSquirreRenderer;
...
public class MidnightModelRegistry {
    ...
    public static void registerModels(ModelRegistryEvent event) {
        ...
        RenderingRegistry.registerEntityRenderingHandler(ShadeSquirreEntity.class, ShadeSquirreRenderer::new);
