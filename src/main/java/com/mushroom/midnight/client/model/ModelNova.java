...
public class ModelNova extends ModelBase {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entity) {
        float angle = (ageInTicks * (((EntityNova) entity).isAttacking() ? 0.7f : 0.4f)) / (2f * (float) Math.PI);
        ...
        rotChunks.rotateAngleX = rotChunks.rotateAngleY = ((EntityNova) entity).isAttacking() ? -2f * angle : 0f;
    }
